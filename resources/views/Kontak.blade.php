...
<main class="contacts main">
      <section class="introductionSection" style="--src:url(/assets/07bd30683d0a863e3020e4c26a844523.png)"><p class="desc">Memulai Kerjasama Bersama Sarponesia</p></section>
        ...
        <div class="contentContainer">
          <div class="programTeamContainer">
            ...
            <div class="programGallery">
              ...
              <img class="programImage" src="/assets/9f905bfaf603048fcff49565e62b7d09.png" alt="alt text" />
              <img class="programImage" src="/assets/5fb4ea91d6468658e4db5de323cbecd7.png" alt="alt text" />
              <img class="programImage" src="/assets/056042f28c32d47cb2faa83d8da80478.png" alt="alt text" />
              <img class="programImage" src="/assets/dfe5d5df4299b3efb4ebf164056e293a.png" alt="alt text" />
            </div>
          </div>
          ...
          <div class="teamContainer">
            <div class="teamMemberContainer">
              <div class="teamProfile">
                <div class="teamProfileCard">
                  <div class="teamMemberDetails">
                    <img class="teamImage" src="/assets/9cce594cbdeb2f0b5dbb4eccfde18b5d.png" alt="alt text" />
                    <div class="memberInfo">
                      <h4 class="memberName">Parno</h4>
                      <p class="memberPosition">Latte artist</p>
                    </div>
                  </div>
                  <img class="teamImage1" src="/assets/d74fa1ef02c441ef4aade8f116359b71.png" alt="alt text" />
                </div>
              ...
              <div class="teamContainer1">
                <div class="teamProfileCard">
                  <div class="teamMemberDetails1">
                    <img class="teamImage2" src="/assets/478f79ae55ccc9d29f5a3353b8af129a.png" alt="alt text" />
                    <div class="memberInfo2">
                      <h4 class="memberName2">Jacob</h4>
                      <p class="memberPosition1">Spesialis</p>
                    </div>
                  </div>
                  <img class="teamImage3" src="/assets/b6e8fe64461a13dfe6e007c5d9f7b6fc.png" alt="alt text" />
                </div>
              ...
              <img class="teamImage4" src="/assets/73d8a8b5e7e7a6796a3220c61ec3b8a5.png" alt="alt text" />
            </div>
          ...
          <div class="contactDetailsGrid">
            ...
            <div class="contactDetailBlock">
              <div class="contactDetailContent">
                <img class="contactDetailIcon" src="/assets/3f25ba6090b6e6ca0e63f0e34da17d8d.svg" alt="alt text" />
            ...
            <div class="contactDetailBlock">
              <div class="contactDetailContent1">
                <img class="contactDetailIcon1" src="/assets/361bf60e8f4552e93d41473e66f0cb96.svg" alt="alt text" />
            ...
            <div class="contactDetailBlock">
              <div class="contactDetailContent2">
                <img class="contactDetailIcon1" src="/assets/2b92e99fc456917286f79a58c4bb5a66.svg" alt="alt text" />
          ...
          <div class="callToActionSection">
            <div class="callToActionContent">
              ...
              <img class="ctaImage" src="/assets/028c074d585ecf43ce83114d5c0d8590.svg" alt="alt text" />
            </div>
